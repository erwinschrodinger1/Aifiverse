...
IL_007e:
	...
	}
	{
		...
		L_29 = VirtFuncInvoker0< TypeU5BU5D_t85B10489E46F06CEC7C4B1CCBD0E01FAB6649755* >::Invoke(104 /* System.Type[] System.Type::GetGenericArguments() */, L_28);
		NullCheck(L_29);
		int32_t L_30 = 0;
		...
		L_33 = VirtFuncInvoker0< TypeU5BU5D_t85B10489E46F06CEC7C4B1CCBD0E01FAB6649755* >::Invoke(104 /* System.Type[] System.Type::GetGenericArguments() */, L_32);
		NullCheck(L_33);
		int32_t L_34 = 1;
		...
		NullCheck(L_36);
		bool L_39;
		L_39 = VirtFuncInvoker1< bool, Type_t * >::Invoke(115 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_36, L_38);
		if (!L_39)
		{
			goto IL_00d8;
		}
	}
	{
		...
		NullCheck(L_40);
		bool L_43;
		L_43 = VirtFuncInvoker1< bool, Type_t * >::Invoke(115 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_40, L_42);
...
IL_0041:
	{
		...
		NullCheck(G_B7_0);
		bool L_16;
		L_16 = VirtFuncInvoker1< bool, Type_t * >::Invoke(115 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, G_B7_0, L_15);
		G_B9_0 = ((int32_t)(L_16));
		goto IL_004f;
	}
